export const data = {
  ...
  Upload: 'Отдача',
  Download: 'Загрузка',
  'Upload Total': 'Всего отдано',
  'Download Total': 'Всего загружено',
  'Active Connections': 'Активные подключения',
  'Memory Usage': 'Использование памяти',
  'Pause Refresh': 'Приостановить обновление',
  'Resume Refresh': 'Возобновить обновление',
  close_all_connections: 'Закрыть все подключения',
  close_filter_connections: 'Закрыть все отфильтрованные подключения',
  Search: 'Поиск',
  Sort: 'Сортировка',
  Up: 'Вверх',
  Down: 'Вниз',
  ...
  search_proxies_placeholder: 'Поиск групп или узлов',
  collapse_all: 'Свернуть все',
  expand_all: 'Развернуть все',
  test_all: 'Проверить все',
  testing: 'Проверка…',
  update_all: 'Обновить все',
  update_proxy_provider: 'Обновить этот провайдер',
  node_qty: '{{n}} узл.',
  sort_natural: 'По умолчанию',
  sort_latency: 'Задержка',
  sort_name: 'Имя',
  secs: '{{n}} с',
  settings_latency: 'Проверка задержки',
  ...
  order_name_asc: 'По имени (А-Я)',
  order_name_desc: 'По имени (Я-А)',
  Connections: 'Подключения',
  current_backend: 'Текущий бэкенд',
  Active: 'Активные',
  switch_backend: 'Сменить бэкенд',
  Closed: 'Закрытые',
  ...
  update_all_rule_provider: 'Обновить все провайдеры правил',
  update_all_proxy_provider: 'Обновить все провайдеры прокси',
  reload_config_file: 'Перезагрузить конфигурацию',
  restart_core: 'Перезапустить ядро',
  upgrade_core: 'Обновить ядро',
  upgrade_core_release: 'Стабильная',
  upgrade_core_alpha: 'Alpha',
  upgrade_core_success: 'Ядро обновлено, выполняется перезапуск',
  ...
  tls_sniffing: 'Сниффер',
  c_host: 'Хост',
  c_sni: 'Sniff хост',
  c_process: 'Процесс',
  c_dl: 'Загр.',
  c_ul: 'Отд.',
  c_dl_speed: 'Скорость загр.',
  c_ul_speed: 'Скорость отд.',
  c_chains: 'Цепочки',
  c_rule: 'Правило',
  c_time: 'Время',
  c_source: 'Источник',
  ...
  close_all_confirm_yes: 'Да, уверен',
  close_all_confirm_no: 'Нет',
  manage_column: 'Настройка столбцов',
  reset_column: 'Сбросить столбцы',
  device_name: 'Метка устройства',
  delete: 'Удалить',
  add_tag: 'Добавить метку',
  client_tag: 'Метки клиентов',
  sourceip_tip: 'Префикс / для регулярных выражений, иначе — точное совпадение',
  disconnect: 'Закрыть подключение',
  conn_details: 'Детали подключения',
  close: 'Закрыть',
  internel: 'Внутреннее подключение',
  Clear: 'Очистить',
};
